"""Lifted from the stdlib test.test_sets module"""
...
class _TestSetOfSets(unittest.TestCase):
    # XXX we don't support auto-conversion of mutable sets
    def test_constructor(self):
        inner = Set([1])
        outer = Set([inner])
        element = list(outer).pop(); outer.remove(inner)
...
# abstract bases
del TestBasicOps, TestOnlySetsInBinaryOps, TestCopying

__all__ = [k for k in globals().keys() if k.startswith('Test')]
__all__.remove('TestSubsets')
